        ...
        <>
            <section className="pt-32 pb-24 bg-center bg-cover team-bg">
                <div className="mx-auto max-w-700px md:container">
                    ...
                    <div className="flex-row flex-wrap justify-center lx:flex mx-minus-15px ">
                        <div className="lx:w-3/12 w-3/5 mx-auto lx:mx-0 lx:px-4 basis-45% xl:basis-3/12 lm:basis-2/6">
