                                ...
                                <div class="flex flex-wrap mx-minus-15px flex-col lm:flex-row">
                                    ...
                                    <div class="lm:w-7/12 w-full basis-7/12 relative px-0 lx:px-[15px]">
                                        <div class=" relative ml-0 lm:ml-[60px] before:content-[''] before:absolute before:w-1.5 before:h-full before:rounded-[5px] before:left-0 before:top-0 before:bg-gradient-to-t before:from-[#10161c] before:to-green">
                                            <div class=" bg-[#1b242e] py-6 px-3 drop-shadow-[0px_3px_7px_0px_rgba(0,0,0,0.21)] relative ml-11 mr-0 mt-0 mb-5 p-ml-11 rounded-lg before:content-[''] before:absolute before:left-[-39px] before:-translate-y-2/4 before:w-0 before:h-0 before:border-solid before:top-2/4 last:mb-0 before:border-t-[20px] before:border-r-0 before:border-b-[20px] before:border-l-[18px] before:border-[transparent_transparent_transparent_#45f882] active before:opacity-[0.9] sm:ml-[35px] sm:mr-0 sm:mt-0 sm:mb-5 sm:px-[25px] ">
                                            ...
                                            <div class="bg-[#1b242e] py-6 px-3 drop-shadow-[0px_3px_7px_0px_rgba(0,0,0,0.21)] relative ml-11 mr-0 mt-0 mb-5 p-ml-11 rounded-lg before:content-[''] before:absolute before:left-[-39px] before:-translate-y-2/4 before:w-0 before:h-0 before:border-solid before:top-2/4 last:mb-0 before:opacity-[0.9] sm:ml-[35px] sm:mr-0 sm:mt-0 sm:mb-5 sm:px-[25px]">
