    ...
    return (
        <>
            <section class="pt-36 pb-pt-36 bg-[url('/src/img/bg/roadmap_bg.jpg')] bg-center bg-cover sm:py-24 xsm:py-24">
                <div class="max-w-full lx:container mx-auto">
                    <div class="flex flex-wrap mx-minus-15px justify-center ">
                        <div class="w-10/12 basis-10/12 relative ">
                            <div class="">
                                <div class="flex flex-wrap mx-minus-15px flex-col lm:flex-row">
                                    <div class="lm:w-5/12 w-full pb-8 lm:pb-0 basis-5/12 ">
                                        <div class="">
                                            <h2 class="title md:text-5xl text-[2rem] font-extrabold tracking-[3px] text-white uppercase leading-none mt-0 mb-7 mx-0 ">a look into roadmaps seasons</h2>
                                    ...
                                    <div class="lm:w-7/12 w-full basis-7/12 relative px-0 lx:px-[15px]">
                                        <div class=" relative ml-0 lm:ml-[60px] before:content-[''] before:absolute before:w-1.5 before:h-full before:rounded-[5px] before:left-0 before:top-0 before:bg-gradient-to-t before:from-[#10161c] before:to-green">
                                            <div class=" bg-[#1b242e] py-6 px-3 drop-shadow-[0px_3px_7px_0px_rgba(0,0,0,0.21)] relative ml-11 mr-0 mt-0 mb-5 p-ml-11 rounded-lg before:content-[''] before:absolute before:left-[-34px] before:-translate-y-2/4 before:w-0 before:h-0 before:border-solid before:top-2/4 last:mb-0 before:border-t-[20px] before:border-r-0 before:border-b-[20px] before:border-l-[18px] before:border-[transparent_transparent_transparent_#45f882] active before:opacity-[0.9] sm:ml-[35px] sm:mr-0 sm:mt-0 sm:mb-5 sm:px-[25px] ">
                                                ...
                                                <img className='absolute transition-all duration-500 pointer-events-none max-h-52 right-5 top-2 opacity-15' src={roadmap} alt="roadmap" />
                                            </div>

                                            <div class="bg-[#1b242e] py-6 px-3 group/animegirl drop-shadow-[0px_3px_7px_0px_rgba(0,0,0,0.21)] relative ml-11 mr-0 mt-0 mb-5 p-ml-11 rounded-lg before:content-[''] before:absolute before:left-[-34px] before:-translate-y-2/4 before:w-0 before:h-0 before:border-solid before:top-2/4 last:mb-0 before:opacity-[0.9] sm:ml-[35px] sm:mr-0 sm:mt-0 sm:mb-5 sm:px-[25px]">
                                                ...
                                                <img className="absolute transition-opacity duration-500 opacity-0 pointer-events-none max-h-52 right-5 top-2 group-hover/animegirl:opacity-15" src={roadmap} alt="roadmap" />
                                            </div>

                                            <div class="bg-[#1b242e] group/animegirl py-6 px-3 drop-shadow-[0px_3px_7px_0px_rgba(0,0,0,0.21)] relative ml-11 mr-0 mt-0 mb-5 p-ml-11 rounded-lg before:content-[''] before:absolute before:left-[-34px] before:-translate-y-2/4 before:w-0 before:h-0 before:border-solid before:top-2/4 last:mb-0 before:opacity-[0.9] sm:ml-[35px] sm:mr-0 sm:mt-0 sm:mb-5 sm:px-[25px]">
