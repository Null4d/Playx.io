import tournament1 from '../img/others/tournament01.jpg';
import tournament2 from '../img/others/tournament02.jpg';
import tournament3 from '../img/others/tournament03.jpg';
                        ...
                        <div class="flex flex-col items-center lg:items-baseline lg:flex-row flex-wrap mx-minus-15px justify-center gutter-25">
                            <div class="w-11/12 md:w-3/5 lg:w-4/12 basis-4/12 relative px-3 xl:px-4">
                                <div class="relative overflow-hidden duration-500 z-1 mt-0 mb-8 mx-0 pt-6 pb-12 px-8 rounded-[0_0_17px_17px] hover:translate-y-[-7px] before:content-[''] before:absolute before:-translate-x-2/4 before:w-[90px] before:h-[90px] before:blur-[50px] before:transition-all before:duration-300 before:before:delay-0 before:z-minus-1 before:left-2/4 before:top-[20%] before:bg-[radial-gradient(circle,#45f882_0%,transparent_100%)] md:border md:pt-6 md:pb-10 md:px-8 md:rounded-[17px] md:border-solid md:border-[#212d38] md:bg-[#19222b] sm:border sm:pt-6 sm:pb-10 sm:px-8 sm:rounded-[17px] sm:border-solid sm:border-[#212d38] sm:bg-[#19222b] xsm:border xsm:pt-6 xsm:pb-10 xsm:px-8 xsm:rounded-[17px] xsm:border-solid xsm:border-[#212d38] xsm:bg-[#19222b]">
                                    ...
                                    <svg class="absolute w-40 h-14 text-green z-minus-1 pointer-events-none left-0 top-0" viewBox="0 0 166 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="absolute flex items-center gap-2 font-extrabold text-BlackBlue text-xl leading-none tracking-wider z-2 py-4 left-0 top-0 font-Barlow">
                                        <i class="text-lg tracking-normal"></i>
                                        <span>🏆 25000</span>
                                    </div>

                                    <div class="mt-0 mb-12 mx-0">
                                        <div class="flex justify-end gap-4 leading-none text-center" data-countdown="2023/5/16">
                                            <ul>
                                                <li className="text-xl font-semibold tracking-widest text-white">00 : 00 : 00 : 00</li>
                                                <li className="text-base font-semibold tracking-widest text-grey">DAY HOUR MIN SEC</li>
                                            </ul>
                                        </div>
                                    </div>

                                    <div class="text-center mt-0 mb-7 mx-0">
                                        <span class="sub block text-base leading-none text-white font-extrabold tracking-wider mt-0 mb-[5px] mx-0 font-Barlow">TOURNAMENT</span>
                                        <h4 class="title text-3xl font-extrabold text-green uppercase tracking-wider m-0">of weekly</h4>
                                    </div>

                                    <div class="text-center text-lg uppercase font-bold tracking-wider flex items-center justify-center gap-[0_13px] border mt-0 mb-10 mx-0 px-5 py-6 rounded-[10px] border-solid border-[#1e2933] bg-[#10181f] font-Barlow">
                                        <span className="text-grey"> 🏆 3 prize Places</span>
                                    </div>

                                    <ul class="list-wrap m-0 p-0 ">
                                        <li class=" mt-0 mb-5 mx-0">
                                            <div class="item flex items-center group">
                                                <div class=" flex-[0_0_auto] w-10 mr-5">
                                                    <img className='rounded-md' src={tournament1} alt="tournament01" />
                                                </div>
                                                <h6 class="text-base text-grey transition-all duration-300 delay-0 tracking-wider m-0 group-hover:text-white uppercase font-semibold ">black ninja</h6>
                                                <span class=" text-green font-semibold tracking-wider ml-auto font-Barlow">$ 75000⚡</span>
                                            </div>
                                        </li>
                                        ...
                                        <li class=" mt-0 mb-5 mx-0">
                                            <div class="item flex items-center group">
                                                <div class=" flex-[0_0_auto] w-10 mr-5">
                                                    <img className='rounded-md' src={tournament2} alt="tournament01" />
                                                </div>
                                                <h6 class="text-base text-grey transition-all duration-300 delay-0 tracking-wider m-0 group-hover:text-white uppercase font-semibold ">Foxtie Max</h6>
                                                <span class=" text-green font-semibold tracking-wider ml-auto font-Barlow">$ 65000⚡</span>
                                            </div>
                                        </li>
                                        ...
                                        <li class="m-0">
                                            <div class="item flex items-center group">
                                                <div class=" flex-[0_0_auto] w-10 mr-5">
                                                    <img className='rounded-md' src={tournament3} alt="tournament01" />
                                                </div>
                                                <h6 class="text-base text-grey transition-all duration-300 delay-0 tracking-wider m-0 group-hover:text-white uppercase font-semibold ">Holam Doxe</h6>
                                                <span class=" text-green font-semibold tracking-wider ml-auto font-Barlow">$ 55000⚡</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="w-11/12 md:w-3/5 lg:w-4/12 basis-4/12 relative px-3 xl:px-4">
                                <div class="relative overflow-hidden  duration-500  z-1 mt-0 mb-8 mx-0 pt-6 pb-12 px-8 rounded-[0_0_17px_17px] hover:translate-y-[-7px] before:content-[''] before:absolute before:-translate-x-2/4 before:w-[90px] before:h-[90px] before:blur-[50px] before:transition-all before:duration-300 before:before:delay-0 before:z-minus-1 before:left-2/4 before:top-[20%] before:bg-[radial-gradient(circle,#ffbe18_0%,transparent_100%)] md:border md:pt-6 md:pb-10 md:px-8 md:rounded-[17px] md:border-solid md:border-[#212d38] md:bg-[#19222b] sm:border sm:pt-6 sm:pb-10 sm:px-8 sm:rounded-[17px] sm:border-solid sm:border-[#212d38] sm:bg-[#19222b] xsm:border xsm:pt-6 xsm:pb-10 xsm:px-8 xsm:rounded-[17px] xsm:border-solid xsm:border-[#212d38] xsm:bg-[#19222b] active">
                                    ...
                                    <svg class="absolute w-40 h-14 text-amber-400 z-minus-1 pointer-events-none left-0 top-0" viewBox="0 0 166 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.00792892 55V11C0.00792892 11 -0.729072 0.988 12.0079 1C24.7449 1.012 160.008 0 160.008 0C160.008 0 172.491 1.863 161.008 10C148.995 18.512 115.008 48 115.008 48C115.008 48 110.021 55.238 90.0079 55C69.9949 54.762 0.00792892 55 0.00792892 55Z" fill="currentcolor"></path>
                                    </svg>
                                    ...
                                    <div class="text-center mt-0 mb-7 mx-0">
                                        <span class="sub block text-base leading-none text-white font-extrabold tracking-wider mt-0 mb-[5px] mx-0 font-Barlow">TOURNAMENT</span>
                                        <h4 class="title text-3xl font-extrabold text-amber-400 uppercase tracking-wider m-0">Lucky card</h4>
                                    </div>

                                    <div class="text-center text-lg uppercase font-bold tracking-wider flex items-center justify-center gap-[0_13px] border mt-0 mb-10 mx-0 px-5 py-6 rounded-[10px] border-solid border-[#1e2933] bg-[#10181f] font-Barlow">
                                        <i class="text-amber-400 text-base"></i>
                                        <span className="text-grey">🏆 10 prize Places</span>
                                    </div>
                                    ...
                                    <ul class="list-wrap m-0 p-0 ">
                                        <li class=" mt-0 mb-5 mx-0">
                                            <div class="item flex items-center group">
                                                ...
                                                <h6 class="text-base text-grey transition-all duration-300 delay-0 tracking-wider m-0 group-hover:text-white uppercase font-semibold ">black ninja</h6>
                                                <span class=" text-amber-400 font-semibold tracking-wider ml-auto font-Barlow">$ 75000⚡</span>
                                            </div>
                                        </li>
                                        <li class=" mt-0 mb-5 mx-0">
                                            <div class="item flex items-center group">
                                                ...
                                                <h6 class="text-base text-grey transition-all duration-300 delay-0 tracking-wider m-0 group-hover:text-white uppercase font-semibold ">Foxtie Max</h6>
                                                <span class=" text-amber-400 font-semibold tracking-wider ml-auto font-Barlow">$ 65000⚡</span>
                                            </div>
                                        </li>
                                        <li class="m-0">
                                            <div class="item flex items-center group">
                                                ...
                                                <h6 class="text-base text-grey transition-all duration-300 delay-0 tracking-wider m-0 group-hover:text-white uppercase font-semibold ">Holam Doxe</h6>
                                                <span class=" text-amber-400 font-semibold tracking-wider ml-auto font-Barlow">$ 55000⚡</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="w-11/12 md:w-3/5 lg:w-4/12 basis-4/12 relative px-3 xl:px-4">
                                <div class="relative overflow-hidden  duration-500  z-1 mt-0 mb-8 mx-0 pt-6 pb-12 px-8 rounded-[0_0_17px_17px] hover:translate-y-[-7px] before:content-[''] before:absolute before:-translate-x-2/4 before:w-[90px] before:h-[90px] before:blur-[50px] before:transition-all before:duration-300 before:before:delay-0 before:z-minus-1 before:left-2/4 before:top-[20%] before:bg-[radial-gradient(circle,#45f882_0%,transparent_100%)] md:border md:pt-6 md:pb-10 md:px-8 md:rounded-[17px] md:border-solid md:border-[#212d38] md:bg-[#19222b] sm:border sm:pt-6 sm:pb-10 sm:px-8 sm:rounded-[17px] sm:border-solid sm:border-[#212d38] sm:bg-[#19222b] xsm:border xsm:pt-6 xsm:pb-10 xsm:px-8 xsm:rounded-[17px] xsm:border-solid xsm:border-[#212d38] xsm:bg-[#19222b]">
                                    ...
                                    <div class="text-center mt-0 mb-7 mx-0">
                                        <span class="sub block text-base leading-none text-white font-extrabold tracking-wider mt-0 mb-[5px] mx-0 font-Barlow">TOURNAMENT</span>
                                        <h4 class="title text-3xl font-extrabold text-green uppercase tracking-wider m-0">of month</h4>
                                    </div>

                                    <div class="text-center text-lg uppercase font-bold tracking-wider flex items-center justify-center gap-[0_13px] border mt-0 mb-10 mx-0 px-5 py-6 rounded-[10px] border-solid border-[#1e2933] bg-[#10181f] font-Barlow">
                                        <i class="text-amber-400 text-base"></i>
                                        <span className="text-grey">🏆 50 prize Places</span>
                                    </div>
