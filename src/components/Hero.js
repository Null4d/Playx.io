    ...
    <>
      <section className="min-h-screen bg-center bg-cover pt-2 lg:pt-40 pb-14 px-0 relative bg-[url('/src/img/slider/slider_bg.jpg')]">
        <div className="relative h-full mx-auto max-w-screen-2xl">
          <div className="flex flex-col flex-wrap w-full lg:flex-row lg:justify-between px-minus-15px">
            <div className="relative flex justify-center w-full px-4 lg:flex-row lg:w-6/12 basis-6/12 lg:justify-normal">
              <div className="relative flex flex-col w-full mt-32 mb-0 ml-0 mr-0 lg:ml-28 2xl:ml-10 z-2">
                ...
                <h2 className="leading-none text-white text-center lg:text-start text-6xl sm:text-8xl 2xl:text-150px mt-0 mb-6 mx-0 font-berlin drop-shadow-[-1px_5px_0px_rgba(69,248,130,0.66)]">
                  STEAMING
                </h2>

                <p className="m-0 text-2xl font-bold text-center text-white uppercase sm:text-3xl lg:text-start">
                  VIDEO GAMES ONLINE 
                </p>

                <div className="mx-0 mt-8 mb-0 text-center lg:text-left">
            ...
            <div className="order-1 w-full moveupAnimation sm:order-0 basis-6/12 lg:w-6/12">
              <div className="">
                <img className='mx-auto my-0 mt-16 lg:mt-0 max-w-96 sm:max-w-lg lg:max-w-lg-0 2xl:max-w-full ' src={heroİmg} alt="heroİmg" />
              </div>
            </div>
          ...
          <ul className="flex items-center justify-center w-full gap-8 px-4 z-3 lg:pl-32 lg:absolute bottom-32 lg:justify-start sm:gap-16 brand-opacity list-wrap ">
