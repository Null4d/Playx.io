                                ...
                                <nav className="flex flex-wrap items-center justify-start w-full pt-5 xl:pt-0">
                                    ...
                                    <div className="flex justify-center navbar-wrap grow">
                                        <ul className="flex-row flex-wrap hidden navigation xl:flex xl:ml-16 2xl:ml-28">
                                            ...
                                            <li className="relative block list-none group">
                                                <Link to="/about" className="text-base font-bold uppercase text-white block leading-none relative tracking-widest z-1 px-6 py-9 font-Barlow before:content-[''] before:absolute before:w-11 before:h-px before:-translate-y-2/4 before:rotate-0 before:opacity-0 before:transition-all before:duration-300 before:delay-0 before:mx-auto before:my-0 before:top-2/4 before:inset-x-0 before:bg-green group-hover:text-green  group-hover:before:opacity-100 group-hover:before:-translate-y-2/4 group-hover:before:rotate-minus-40px-">
                                                    ABOUT US
                                                </Link>
                                            </li>
                                            <li className="relative block list-none group">
                                                <Link to="/tournament" className="text-base font-bold uppercase text-white block leading-none relative tracking-widest z-1 px-6 py-9 font-Barlow before:content-[''] before:absolute before:w-11 before:h-px before:-translate-y-2/4 before:rotate-0 before:opacity-0 before:transition-all before:duration-300 before:delay-0 before:mx-auto before:my-0 before:top-2/4 before:inset-x-0 before:bg-green group-hover:text-green  group-hover:before:opacity-100 group-hover:before:-translate-y-2/4 group-hover:before:rotate-minus-40px-">
                                                    TOURNAMENT
                                                </Link>
                                            </li>
                                            <li className="relative block list-none group">
                                                <Link to="/pages" className="text-base font-bold uppercase text-white block leading-none relative tracking-widest z-1 px-6 py-9 font-Barlow before:content-[''] before:absolute before:w-11 before:h-px before:-translate-y-2/4 before:rotate-0 before:opacity-0 before:transition-all before:duration-300 before:delay-0 before:mx-auto before:my-0 before:top-2/4 before:inset-x-0 before:bg-green group-hover:text-green  group-hover:before:opacity-100 group-hover:before:-translate-y-2/4 group-hover:before:rotate-minus-40px-">
                                                    PAGES
                                                </Link>
                                            </li>
                                            <li className="relative block list-none group">
                                                <Link to="/news" className="text-base font-bold uppercase text-white block leading-none relative tracking-widest z-1 px-6 py-9 font-Barlow before:content-[''] before:absolute before:w-11 before:h-px before:-translate-y-2/4 before:rotate-0 before:opacity-0 before:transition-all before:duration-300 before:delay-0 before:mx-auto before:my-0 before:top-2/4 before:inset-x-0 before:bg-green group-hover:text-green  group-hover:before:opacity-100 group-hover:before:-translate-y-2/4 group-hover:before:rotate-minus-40px-">
                                                    NEWS
                                                </Link>
                                            </li>
                                            <li className="relative block list-none group">
